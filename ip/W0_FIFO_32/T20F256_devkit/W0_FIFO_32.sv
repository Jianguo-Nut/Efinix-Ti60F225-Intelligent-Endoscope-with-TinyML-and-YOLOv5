...
`define IP_UUID _61c590f2648c422292e7203196305d24
...
#(
    ...
    .MODE ("FWFT"),
    .OUTPUT_REG (0),
    .PROG_FULL_ASSERT (1536),
    .PROGRAMMABLE_FULL ("STATIC_SINGLE"),
    .PROG_FULL_NEGATE (1536),
    .PROGRAMMABLE_EMPTY ("STATIC_SINGLE"),
    .PROG_EMPTY_ASSERT (127),
    .PROG_EMPTY_NEGATE (128),
    .OPTIONAL_FLAGS (0),
    .PIPELINE_REG (1),
    .DEPTH (2048),
    .FAMILY ("TITANIUM"),
