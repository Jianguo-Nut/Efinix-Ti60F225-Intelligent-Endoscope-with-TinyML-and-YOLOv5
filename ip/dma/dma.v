...
`define IP_UUID _2916863c435b43a2a4660b724af90168
...
// Component : EfxDMA_2916863c435b43a2a4660b724af90168

`timescale 1ns/1ps

module EfxDMA_2916863c435b43a2a4660b724af90168 (
  ...
  EfxDMA_Core_2916863c435b43a2a4660b724af90168 core (
  ...
  EfxDMA_Apb3CC_2916863c435b43a2a4660b724af90168 withCtrlCc_apbCc (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_6_2916863c435b43a2a4660b724af90168 io_interrupts_buffercc (
    .io_dataIn  (core_io_interrupts[1:0]               ), //i
    .io_dataOut (io_interrupts_buffercc_io_dataOut[1:0]), //o
    .ctrl_clk   (ctrl_clk                              ), //i
    .ctrl_reset (ctrl_reset                            )  //i
  );
  EfxDMA_BmbSourceRemover_2916863c435b43a2a4660b724af90168 readLogic_sourceRemover (
  ...
  EfxDMA_BmbToAxi4ReadOnlyBridge_2916863c435b43a2a4660b724af90168 readLogic_bridge (
  ...
  EfxDMA_BmbSourceRemover_1_2916863c435b43a2a4660b724af90168 writeLogic_sourceRemover (
  ...
  EfxDMA_BmbToAxi4WriteOnlyBridge_2916863c435b43a2a4660b724af90168 writeLogic_bridge (
  ...
  EfxDMA_StreamFifoCC_2916863c435b43a2a4660b724af90168 inputsAdapter_0_crossclock_fifo (
  ...
  EfxDMA_StreamFifoCC_1_2916863c435b43a2a4660b724af90168 outputsAdapter_0_crossclock_fifo (
...
module EfxDMA_StreamFifoCC_1_2916863c435b43a2a4660b724af90168 (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_3_2916863c435b43a2a4660b724af90168 popToPushGray_buffercc (
    .io_dataIn  (popToPushGray[4:0]                    ), //i
    .io_dataOut (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .clk        (clk                                   ), //i
    .reset      (reset                                 )  //i
  );
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_5_2916863c435b43a2a4660b724af90168 pushToPopGray_buffercc (
...
module EfxDMA_StreamFifoCC_2916863c435b43a2a4660b724af90168 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
  input  wire [63:0]   io_push_payload_data,
  input  wire [7:0]    io_push_payload_mask,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_2_2916863c435b43a2a4660b724af90168 popToPushGray_buffercc (
    .io_dataIn    (popToPushGray[4:0]                    ), //i
    .io_dataOut   (popToPushGray_buffercc_io_dataOut[4:0]), //o
    .dat0_i_clk   (dat0_i_clk                            ), //i
    .dat0_i_reset (dat0_i_reset                          )  //i
  );
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_3_2916863c435b43a2a4660b724af90168 pushToPopGray_buffercc (
    .io_dataIn  (pushToPopGray[4:0]                    ), //i
    .io_dataOut (pushToPopGray_buffercc_io_dataOut[4:0]), //o
    .clk        (clk                                   ), //i
    .reset      (reset                                 )  //i
...
module EfxDMA_BmbToAxi4WriteOnlyBridge_2916863c435b43a2a4660b724af90168 (
  ...
  EfxDMA_BmbContextRemover_1_2916863c435b43a2a4660b724af90168 contextRemover (
...
module EfxDMA_BmbSourceRemover_1_2916863c435b43a2a4660b724af90168 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
...
module EfxDMA_BmbToAxi4ReadOnlyBridge_2916863c435b43a2a4660b724af90168 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_BmbContextRemover_2916863c435b43a2a4660b724af90168 contextRemover (
    .io_input_cmd_valid                     (io_input_cmd_valid                                         ), //i
    .io_input_cmd_ready                     (contextRemover_io_input_cmd_ready                          ), //o
    .io_input_cmd_payload_last              (io_input_cmd_payload_last                                  ), //i
    .io_input_cmd_payload_fragment_opcode   (io_input_cmd_payload_fragment_opcode                       ), //i
...
module EfxDMA_BmbSourceRemover_2916863c435b43a2a4660b724af90168 (
  input  wire          io_input_cmd_valid,
  output wire          io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
...
module EfxDMA_BufferCC_6_2916863c435b43a2a4660b724af90168 (
...
module EfxDMA_Apb3CC_2916863c435b43a2a4660b724af90168 (
  ...
  EfxDMA_FlowCCUnsafeByToggle_2916863c435b43a2a4660b724af90168 flowCCUnsafeByToggle (
  ...
  EfxDMA_FlowCCUnsafeByToggle_1_2916863c435b43a2a4660b724af90168 flowCCUnsafeByToggle_1 (
...
module EfxDMA_Core_2916863c435b43a2a4660b724af90168 (
  ...
  EfxDMA_DmaMemoryCore_2916863c435b43a2a4660b724af90168 memory_core (
  ...
  EfxDMA_Aggregator_2916863c435b43a2a4660b724af90168 b2m_fsm_aggregate_engine (
...
module EfxDMA_BufferCC_5_2916863c435b43a2a4660b724af90168 (
...
//EfxDMA_BufferCC_4 replaced by EfxDMA_BufferCC_3_2916863c435b43a2a4660b724af90168

module EfxDMA_BufferCC_3_2916863c435b43a2a4660b724af90168 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          clk,
  input  wire          reset
...
module EfxDMA_BufferCC_2_2916863c435b43a2a4660b724af90168 (
  input  wire [4:0]    io_dataIn,
  output wire [4:0]    io_dataOut,
  input  wire          dat0_i_clk,
  input  wire          dat0_i_reset
...
module EfxDMA_BmbContextRemover_1_2916863c435b43a2a4660b724af90168 (
  input  wire          io_input_cmd_valid,
  ...
  EfxDMA_StreamFifo_1_2916863c435b43a2a4660b724af90168 fifoFork_thrown_translated_fifo (
...
module EfxDMA_BmbContextRemover_2916863c435b43a2a4660b724af90168 (
  input  wire          io_input_cmd_valid,
  output reg           io_input_cmd_ready,
  input  wire          io_input_cmd_payload_last,
  input  wire [0:0]    io_input_cmd_payload_fragment_opcode,
  ...
  EfxDMA_StreamFifo_2916863c435b43a2a4660b724af90168 fifoFork_thrown_translated_fifo (
    .io_push_valid           (fifoFork_thrown_translated_valid                            ), //i
    .io_push_ready           (fifoFork_thrown_translated_fifo_io_push_ready               ), //o
...
module EfxDMA_FlowCCUnsafeByToggle_1_2916863c435b43a2a4660b724af90168 (
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_1_2916863c435b43a2a4660b724af90168 inputArea_target_buffercc (
...
module EfxDMA_FlowCCUnsafeByToggle_2916863c435b43a2a4660b724af90168 (
  input  wire          io_input_valid,
  ...
  (* keep_hierarchy = "TRUE" *) EfxDMA_BufferCC_2916863c435b43a2a4660b724af90168 inputArea_target_buffercc (
    .io_dataIn  (inputArea_target                    ), //i
    .io_dataOut (inputArea_target_buffercc_io_dataOut), //o
    .clk        (clk                                 ), //i
    .reset      (reset                               )  //i
...
module EfxDMA_Aggregator_2916863c435b43a2a4660b724af90168 (
  input  wire          io_input_valid,
...
module EfxDMA_DmaMemoryCore_2916863c435b43a2a4660b724af90168 (
...
module EfxDMA_StreamFifo_1_2916863c435b43a2a4660b724af90168 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
...
module EfxDMA_StreamFifo_2916863c435b43a2a4660b724af90168 (
  input  wire          io_push_valid,
  output wire          io_push_ready,
...
module EfxDMA_BufferCC_1_2916863c435b43a2a4660b724af90168 (
...
module EfxDMA_BufferCC_2916863c435b43a2a4660b724af90168 (
  input  wire          io_dataIn,
  output wire          io_dataOut,
  input  wire          clk,
  input  wire          reset
