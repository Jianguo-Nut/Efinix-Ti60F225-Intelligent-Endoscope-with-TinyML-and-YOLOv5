...
module EfxDMA (
  ...
  wire       [20:0]   core_io_read_cmd_payload_fragment_context;
  ...
  wire       [20:0]   readLogic_sourceRemover_io_input_rsp_payload_fragment_context;
  ...
  wire       [20:0]   interconnect_read_aggregated_cmd_payload_fragment_context;
  ...
  wire       [20:0]   interconnect_read_aggregated_rsp_payload_fragment_context;
  ...
  wire       [20:0]   readLogic_resized_cmd_payload_fragment_context;
  ...
  wire       [20:0]   readLogic_resized_rsp_payload_fragment_context;
  ...
  wire       [20:0]   interconnect_read_aggregated_cmd_halfPipe_payload_fragment_context;
  ...
  reg        [20:0]   interconnect_read_aggregated_cmd_rData_fragment_context;
  ...
  wire       [20:0]   readLogic_resized_rsp_combStage_payload_fragment_context;
  ...
  wire       [12:0]   writeLogic_resized_cmd_payload_fragment_context;
  ...
  wire       [20:0]   interconnect_read_aggregated_slaveModel_arbiterGen_oneToOne_arbiter_cmd_payload_fragment_context;
  ...
  wire       [20:0]   interconnect_read_aggregated_slaveModel_arbiterGen_oneToOne_arbiter_rsp_payload_fragment_context;
  ...
  EfxDMA_Core core (
    ...
    .io_read_cmd_payload_fragment_context  (core_io_read_cmd_payload_fragment_context[20:0]                                                        ), //o
    ...
    .io_read_rsp_payload_fragment_context  (interconnect_read_aggregated_slaveModel_arbiterGen_oneToOne_arbiter_rsp_payload_fragment_context[20:0] ), //i
  ...
  EfxDMA_BmbSourceRemover readLogic_sourceRemover (
    ...
    .io_input_cmd_payload_fragment_context  (readLogic_resized_cmd_payload_fragment_context[20:0]                ), //i
    ...
    .io_input_rsp_payload_fragment_context  (readLogic_sourceRemover_io_input_rsp_payload_fragment_context[20:0] ), //o
  ...
  EfxDMA_BmbSourceRemover_1 writeLogic_sourceRemover (
    ...
    .io_input_cmd_payload_fragment_context  (writeLogic_resized_cmd_payload_fragment_context[12:0]                ), //i
...
module EfxDMA_BmbSourceRemover_1 (
  ...
  assign rspContext_context = io_output_rsp_payload_fragment_context[12 : 0];
...
module EfxDMA_BmbSourceRemover (
  ...
  wire       [20:0]   cmdContext_context;
  wire       [20:0]   rspContext_context;
  ...
  assign io_output_cmd_payload_fragment_length = io_input_cmd_payload_fragment_length;
  assign io_output_cmd_payload_fragment_context = cmdContext_context;
  assign rspContext_context = io_output_rsp_payload_fragment_context[20 : 0];
  assign io_input_rsp_valid = io_output_rsp_valid;
  assign io_output_rsp_ready = io_input_rsp_ready;
  assign io_input_rsp_payload_last = io_output_rsp_payload_last;
  assign io_input_rsp_payload_fragment_opcode = io_output_rsp_payload_fragment_opcode;
...
module EfxDMA_Core (
  ...
  output wire [20:0]   io_read_cmd_payload_fragment_context,
  ...
  input  wire [20:0]   io_read_rsp_payload_fragment_context,
  ...
  reg        [15:0]   memory_core_io_writes_1_cmd_payload_mask;
  ...
  wire       [20:0]   _zz_m2b_rsp_context_start;
  ...
  wire       [127:0]  memory_core_io_reads_1_rsp_s2mPipe_payload_data;
  wire       [15:0]   memory_core_io_reads_1_rsp_s2mPipe_payload_mask;
  wire       [12:0]   memory_core_io_reads_1_rsp_s2mPipe_payload_context;
  reg                 memory_core_io_reads_1_rsp_rValidN;
  reg        [127:0]  memory_core_io_reads_1_rsp_rData_data;
  reg        [15:0]   memory_core_io_reads_1_rsp_rData_mask;
  ...
  wire       [12:0]   _zz_b2m_rsp_context_length;
  ...
  assign _zz_channels_1_fifo_push_ptrIncr_value_1 = ((memory_core_io_writes_1_cmd_fire && 1'b1) ? 2'b10 : 2'b00);
  ...
  EfxDMA_DmaMemoryCore memory_core (
    ...
    .io_writes_1_cmd_payload_data     (io_read_rsp_payload_fragment_data[127:0]         ), //i
    .io_writes_1_cmd_payload_mask     (memory_core_io_writes_1_cmd_payload_mask[15:0]   ), //i
  ...
  assign m2b_rsp_context_start = _zz_m2b_rsp_context_start[3 : 0];
  assign m2b_rsp_context_stop = _zz_m2b_rsp_context_start[7 : 4];
  assign m2b_rsp_context_length = _zz_m2b_rsp_context_start[19 : 8];
  assign m2b_rsp_context_last = _zz_m2b_rsp_context_start[20];
  ...
  always @(*) begin
    memory_core_io_writes_1_cmd_payload_mask[0] = ((! (m2b_rsp_first && (4'b0000 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0000))));
    memory_core_io_writes_1_cmd_payload_mask[1] = ((! (m2b_rsp_first && (4'b0001 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0001))));
    memory_core_io_writes_1_cmd_payload_mask[2] = ((! (m2b_rsp_first && (4'b0010 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0010))));
    memory_core_io_writes_1_cmd_payload_mask[3] = ((! (m2b_rsp_first && (4'b0011 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0011))));
    memory_core_io_writes_1_cmd_payload_mask[4] = ((! (m2b_rsp_first && (4'b0100 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0100))));
    memory_core_io_writes_1_cmd_payload_mask[5] = ((! (m2b_rsp_first && (4'b0101 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0101))));
    memory_core_io_writes_1_cmd_payload_mask[6] = ((! (m2b_rsp_first && (4'b0110 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0110))));
    memory_core_io_writes_1_cmd_payload_mask[7] = ((! (m2b_rsp_first && (4'b0111 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b0111))));
    memory_core_io_writes_1_cmd_payload_mask[8] = ((! (m2b_rsp_first && (4'b1000 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1000))));
    memory_core_io_writes_1_cmd_payload_mask[9] = ((! (m2b_rsp_first && (4'b1001 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1001))));
    memory_core_io_writes_1_cmd_payload_mask[10] = ((! (m2b_rsp_first && (4'b1010 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1010))));
    memory_core_io_writes_1_cmd_payload_mask[11] = ((! (m2b_rsp_first && (4'b1011 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1011))));
    memory_core_io_writes_1_cmd_payload_mask[12] = ((! (m2b_rsp_first && (4'b1100 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1100))));
    memory_core_io_writes_1_cmd_payload_mask[13] = ((! (m2b_rsp_first && (4'b1101 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1101))));
    memory_core_io_writes_1_cmd_payload_mask[14] = ((! (m2b_rsp_first && (4'b1110 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1110))));
    memory_core_io_writes_1_cmd_payload_mask[15] = ((! (m2b_rsp_first && (4'b1111 < m2b_rsp_context_start))) && (! (io_read_rsp_payload_last && (m2b_rsp_context_stop < 4'b1111))));
  end
  ...
  assign m2b_writeRsp_context_loadByteInNextBeat = _zz_m2b_writeRsp_context_last[6 : 2];
  ...
  assign b2m_rsp_context_length = _zz_b2m_rsp_context_length[11 : 0];
  assign b2m_rsp_context_doPacketSync = _zz_b2m_rsp_context_length[12];
  ...
  always @(posedge clk) begin
    ...
    if(when_DmaSg_l1102) begin
      if(_zz_when_1[0]) begin
        channels_0_pop_b2m_bytesToSkip <= (b2m_fsm_aggregate_engine_io_output_usedUntil + 4'b0001);
      end
    end
    case(io_ctrl_PADDR)
      14'h000c : begin
...
module EfxDMA_DmaMemoryCore (
  ...
  input  wire [12:0]   io_reads_1_cmd_payload_context,
  ...
  output wire [12:0]   io_reads_1_rsp_payload_context,
  input  wire          clk,
  input  wire          reset
);
  ...
  wire       [12:0]   read_ports_1_buffer_bufferOut_payload_context;
  ...
  wire       [82:0]   _zz_banks_0_writeOr_value_valid_8;
  ...
  wire       [82:0]   _zz_banks_1_writeOr_value_valid_8;
  ...
  always @(*) begin
    if(when_MemoryCore_l136_3) begin
      _zz_banks_1_writeOr_value_valid_6 = io_writes_1_cmd_payload_data[127 : 64];
    end else begin
  ...
  always @(*) begin
    if(when_MemoryCore_l136_3) begin
      _zz_banks_1_writeOr_value_valid_7 = io_writes_1_cmd_payload_mask[15 : 8];
    end else begin
  ...
  assign _zz_banks_0_writeOr_value_payload_address = _zz_banks_0_writeOr_value_valid_8[82 : 1];
  ...
  assign _zz_banks_1_writeOr_value_payload_address = _zz_banks_1_writeOr_value_valid_8[82 : 1];
