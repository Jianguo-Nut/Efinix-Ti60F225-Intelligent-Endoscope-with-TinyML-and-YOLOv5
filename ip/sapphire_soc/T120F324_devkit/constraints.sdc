# PLL Constraints
#################
create_clock -period 3.33 io_systemClk
...
# False Path
#################
set_clock_groups -exclusive  -group {io_systemClk} -group {io_memoryClk} -group {jtag_inst1_TCK} -group {io_peripheralClk}

#SPI Constraints
#################
set_output_delay -clock io_peripheralClk -max -4.700 [get_ports {system_spi_0_io_sclk_write}]
set_output_delay -clock io_peripheralClk -min -2.571 [get_ports {system_spi_0_io_sclk_write}]
set_output_delay -clock io_peripheralClk -max -4.700 [get_ports {system_spi_0_io_ss}]
set_output_delay -clock io_peripheralClk -min -2.571 [get_ports {system_spi_0_io_ss}]
set_input_delay -clock io_peripheralClk -max 6.168 [get_ports {system_spi_0_io_data_0_read}]
set_input_delay -clock io_peripheralClk -min 3.084 [get_ports {system_spi_0_io_data_0_read}]
set_output_delay -clock io_peripheralClk -max -4.700 [get_ports {system_spi_0_io_data_0_write}]
set_output_delay -clock io_peripheralClk -min -2.571 [get_ports {system_spi_0_io_data_0_write}]
set_output_delay -clock io_peripheralClk -max -4.707 [get_ports {system_spi_0_io_data_0_writeEnable}]
set_output_delay -clock io_peripheralClk -min -2.567 [get_ports {system_spi_0_io_data_0_writeEnable}]
set_input_delay -clock io_peripheralClk -max 6.168 [get_ports {system_spi_0_io_data_1_read}]
set_input_delay -clock io_peripheralClk -min 3.084 [get_ports {system_spi_0_io_data_1_read}]
set_output_delay -clock io_peripheralClk -max -4.700 [get_ports {system_spi_0_io_data_1_write}]
set_output_delay -clock io_peripheralClk -min -2.571 [get_ports {system_spi_0_io_data_1_write}]
set_output_delay -clock io_peripheralClk -max -4.707 [get_ports {system_spi_0_io_data_1_writeEnable}]
set_output_delay -clock io_peripheralClk -min -2.567 [get_ports {system_spi_0_io_data_1_writeEnable}]
