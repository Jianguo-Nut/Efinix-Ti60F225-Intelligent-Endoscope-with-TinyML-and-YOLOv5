...
port (
    ...
    system_gpio_0_io_writeEnable : out std_logic_vector(7 downto 0);
    system_gpio_0_io_write : out std_logic_vector(7 downto 0);
    system_gpio_1_io_write : out std_logic_vector(1 downto 0);
    system_gpio_1_io_read : in std_logic_vector(1 downto 0);
    system_gpio_1_io_writeEnable : out std_logic_vector(1 downto 0);
    system_gpio_0_io_read : in std_logic_vector(7 downto 0)
);
end component touch_soc;

---------------------- End COMPONENT Declaration ------------
------------- Begin Cut here for INSTANTIATION Template -----
u_touch_soc : touch_soc
port map (
