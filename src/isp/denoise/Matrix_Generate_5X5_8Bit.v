...
begin
    ...
    begin
        if((per_img_href == 1'b1)&&(vcnt == 11'd2)&&(hcnt == 11'b0))
            vsync[0] <= 1'b1;
        else if((extend_1st_last_row_en == 1'b0)&&(extend_1st_last_row_en_dly == 1'b1))
            vsync[0] <= 1'b0;
        else
            vsync[0] <= vsync[0];
        vsync[2:1] <= vsync[1:0];
