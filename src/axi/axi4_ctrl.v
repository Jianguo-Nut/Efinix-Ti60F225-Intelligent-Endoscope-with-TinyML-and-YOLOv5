			...
			case ({r_rframe_inc, r_wframe_inc})
				...
				2'b10: begin
						...
						if (enable) begin
							...
							rc_rframe_index_fixed <= r_wframe_index_last; 
						end else begin
							// enable为低时，保持当前帧索引不变
							rc_rframe_index <= rc_rframe_index_fixed;
						end
					end
				2'b11: begin
						...
						if (enable) begin
							...
							rc_rframe_index_fixed <= rc_wframe_index;
						end else begin
							// enable为低时，保持当前帧索引不变
							rc_rframe_index <= rc_rframe_index_fixed;
						end
