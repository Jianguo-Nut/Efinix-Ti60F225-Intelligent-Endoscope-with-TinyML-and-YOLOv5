...
extern "C" void main() {
   ...
   //layer* yolo_layers = (layer*)malloc(total_output_layers * sizeof(layer));
   for (int i = 0; i < total_output_layers; ++i) {
      ...
      //yolo_layers[i].outputs = (float*)malloc(total * sizeof(float));
