...
create_clock -period 13.4409 -name clk_pixel [get_ports {clk_pixel}]
...
set_clock_groups    -group  {   clk_pixel  }

set_false_path -from [get_clocks core_clk] -to [get_clocks csi_rxc_i]
set_false_path -from [get_clocks csi_rxc_i] -to [get_clocks core_clk]
# GPIO Constraints
####################
